...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
      {/* Navigation - Consistent with other levels */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-xl font-bold text-white">Psychology-Driven Development</h1>
                <p className="text-sm text-gray-400">Interactive Psychology - React + Node.js</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="px-3 py-2 text-purple-400 font-semibold">
